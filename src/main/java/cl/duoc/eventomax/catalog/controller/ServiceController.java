...
@Tag(name = "Service Catalog", description = "Endpoints for managing EventoMax catalog services")
public class ServiceController {
    ...
    @GetMapping
    @Operation(summary = "List all services", description = "Returns all services registered in the catalog.")
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get service by ID", description = "Returns a single catalog service.")
    ...
    @Operation(summary = "Create service", description = "Creates a catalog service.")
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Update service", description = "Replaces the editable fields of an existing catalog service.")
